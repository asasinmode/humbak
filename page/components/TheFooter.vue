...
<template>
	<footer class="relative grid grid-cols-1 w-full justify-items-center gap-4 bg-humbak pb-4 pt-6 text-black md:px-[clamp(2rem,_-12.25rem_+_29.6875vw,_6.75rem)] mt-auto lg:px-8">
