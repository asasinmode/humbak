...
import { nonEmptyMaxLengthString, nonEmptyStringValidation } from '../../validation';
...
export const insertFooterContentsSchema = v.object({
	...
	emails: v.optional(v.array(nonEmptyStringValidation)),
	phoneNumbers: v.optional(v.array(nonEmptyStringValidation)),
	location: v.optional(v.object({
		text: v.pipe(v.string(), v.maxLength(256)),
		value: v.pipe(v.string(), v.maxLength(256)),
	})),
