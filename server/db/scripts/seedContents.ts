...
<section>
	...
	<h3>content</h3>
	<p>The cms' main feature is creating pages, which can be done on the <a href="/admin" target="_blank" class="text-link">admin home page</a>. Once there, you can browse and search all the pages and edit their <em>content</em>, <em>css</em> and <em>meta</em>.</p>

	<h4>pages table</h4>
	<p>Located at the top are the <a href="/admin" target="_blank" class="text-link">home page</a> are a search input and a table. The table contains all the created pages and can be filtered using the input above it. Each page has <b>edit</b> and <b>delete</b> buttons.</p>
	<HumbakFile fid="${pagesTable}" loading="lazy"></HumbakFile>

	<h4>page form</h4>
	<p>Below the table there is a form consisting of 4 text fields, the <b>editor</b> and the <b>preview box</b>. Between the <em>editor</em> and the <em>preview box</em> are <b>control buttons</b>. Going from top to bottom, the <em>control buttons</em> are: <b>editor mode select</b>, <b>content formatting</b>, <b>snippets</b> and <b>Humbak Files</b>. The last, gray button in the middle can be used to resize the <em>editor</em>. Lastly, below the <b>editor</b> there are the <b>clear</b> and <b>save</b> buttons.</p>
	...
	<p><em>Humbak files</em> can be uploaded on the <a href="/admin/files" target="_blank" class="text-link">files page</a> and have some special features that are described in the <a href="#files" class="text-link">humbak files</a> section. To make their features work, inside the page html you use them through a special tag <code style="background-color: hsl(0 0% 25%); color: white; border-radius: 0.25rem; padding-block: 0.125rem; padding-inline: 0.25rem;"><span style="color: hsl(0 0% 60%)">&lt;</span><span style="color: hsl(205 100% 65%)">HumbakFile</span> <span style="color: hsl(205 100% 80%)">fid</span><span style="color: hsl(0 0% 60%)">=</span><span style="color: hsl(30 100% 65%)">"1"</span><span style="color: hsl(0 0% 60%)">&gt;</span></code>. They require a special <b>fid</b> attribute that contains the target <em>humbak file's</em> id and accept all valid html attributes, such as <em>class</em> or <em>style</em>.</p>
	<HumbakFile fid="${pagesHumbakFileTag}" loading="lazy"></HumbakFile>
</section>

<section>
	<h3>menu</h3>
	<p>After creating pages you can manage the menu layout on the <a href="/admin/menu" target="_blank" class="text-link">admin menu page</a>.</p>
...
<section>
	...
	<p><b>Humbak files</b> can be uploaded and managed on the <a href="/admin/files" target="_blank" class="text-link">admin files page</a>.</p>
	<p class="indent">
		In the top left corner you can find the <b>directory breadcrumbs</b> that show the current directory, the path to it and can be used to navigate directory structure. To the right of it, there are 2 buttons used to toggle between <b>list</b> and <b>tile</b> view, along with the <b>save button</b>.
	</p>
	<HumbakFile fid="${filesToggling}" loading="lazy"></HumbakFile>
	<p>Below these are all of your files with the exception of the first item that's used to create new directories and upload new files. Besides editing files and directories' attributes you can navigate to directories or delete/move files and directories. The <b>move</b> button can either be dragged to the target directory or be clicked on to open the <b>move dialog</b>.</p>
...
<section>
	<h3>global</h3>
	<p>While on the <a href="/admin" target="_blank" class="text-link">admin home page</a> you can edit <em>css</em> and <em>meta</em> specific to each page, the <a href="/admin/global" target="_blank" class="text-link">admin global page</a> is used to manage <em>css</em> and <em>meta</em> shared between all pages (with <em>meta</em> being language-specific).</p>
	<p class="indent">
...
<section>
	<h3>slider</h3>
	<p>The <b>slider</b> seen at the top of all of your pages can be configured on the <a href="/admin/slider" target="_blank" class="text-link">admin slider page</a>.</p>
	<p class="indent">
		The first row on the page contains the <b>language select</b>, the <b>slide select</b>, in order, <b>humbak files</b>, <b>slider settings</b> and <b>content formatting</b> <em>control buttons</em> and the <b>clear</b> and <b>save</b> buttons. Below these is the <b>editor</b>, under which is a form for managing the current slide's attributes: <em>name</em>, <em>language</em> and <em>visibility</em>.
	</p>
	<HumbakFile fid="${sliderForm}" loading="lazy"></HumbakFile>
	<p>Under the form are the <b>preview box</b>, showing the preview of currently edited slide, and a copy of the <b>slider</b> seen on the <a href="/" target="_blank" class="text-link">page</a>. Note that while the <em>preview box</em> updates in real time with current slide's <em>html</em>, the <em>slider</em> updates only after saving current changes.</p>
...
<section>
	<h3>footer</h3>
	<p>Similarly to the <b>slider</b>, the <b>footer</b> can be edited on the <a href="/admin/footer" target="_blank" class="text-link">admin footer page</a>.</p>
	<p class="indent">
		At the top are the <b>language select</b> and the <b>save</b> button, below which you can find an interactive preview of the footer. In the first column you can add and edit <em>emails</em>, in the second <em>phone numbers</em> and in the last the <em>location link</em>. Below these columns, in the second row, are <em>social links</em> that can be edited in the <b>social dialog</b>.
	</p>
	<HumbakFile fid="${footerOverview}" loading="lazy"></HumbakFile>

	<h4>socials dialog</h4>
	<p>Inside of the dialog you can add and edit a select few <em>social links</em> that will show up at the bottom of the footer.</p>
	<HumbakFile fid="${footerSocialsDialog}" loading="lazy"></HumbakFile>
</section>

<section>
	<h3>settings</h3>
	<p>Lastly, on the <a href="/admin/settings" target="_blank" class="text-link">admin settings page</a> you can log out and change your admin account's <em>name</em> and <em>password</em>.</p>
...
export function plHomePageContent(
	...
	return `<section>
	<h1>humbak demo</h1>
	<p>To jest strona demo dla <strong>humbak</strong>, bloga z wbudowanym CMS-em (content managment site - strona do zarządzania zawartością). Obecna zawartość przedstawia dostępną funkcjonalność CMS'a i powinna być resetowana regularnie. Większość tekstu została wygenerowana przez <a href="https://chat.openai.com/" target="_blank" class="text-link">ChatGPT</a> a wiekszość obrazów wzięta z <a href="https://unsplash.com/" target="_blank" class="text-link">Unsplash</a>.</p>
</section>

<section>
	<h2>struktura</h2>

	<p><strong>Humbak</strong> może być podzielony na 3 sekcje: <a href="#" class="text-link">główną stronę</a> (którą w tym momencie przeglądasz) oraz podstrony <a href="/api" target="_blank" class="text-link">/api</a> i <a href="/admin" target="_blank" class="text-link">/admin</a>.</p>
	<p class="indent"><a href="#" class="text-link">Główna strona</a> wyświetla zawartość, którą zarządza się na <a href="/admin" target="_blank" class="text-link">stronie admina</a>. Obydwie te strony używają <a href="/api" target="_blank" class="text-link">strony /api</a> do komunikowania się ze sobą. Poza <a href="/api" target="_blank" class="text-link fancy-underline">główną stroną /api</a>, nie ma na niej za wiele. Reszta tej strony zawiera opis funkcjonalności dostępnej na <a href="/admin" target="_blank" class="text-link">stronie /admin</a> i instrukcje jak jej używać.</p>
</section>
...
<section>
	...
	<h3>zawartość</h3>
	<p>Główną funkcjonalnością cms'a jest tworzenie stron, które odbywa się na <a href="/admin" target="_blank" class="text-link">głównej stronie admina</a>. Możesz na niej szukać i przeglądać wszystkie strony oraz edytować ich <em>zawartość</em>, <em>css</em> i <em>metę</em>.</p>

	<h4>tabela stron</h4>
	<p>Na samej górze <a href="/admin" target="_blank" class="text-link">strony głównej</a> znajdują się wyszukiwarka i tabela. Tabela zawiera wszystkie utworzone strony i może być filtrowana przez wyszukiwarkę nad nią. Każda strona w tabeli ma przyciski <b>edytuj</b> oraz <b>usuń</b>.</p>
	<HumbakFile fid="${pagesTable}" loading="lazy"></HumbakFile>
	...
	<HumbakFile fid="${pagesHumbakFiles}" loading="lazy"></HumbakFile>
	<p><em>Humbak pliki</em> mogą być wgrywane na <a href="/admin/files" target="_blank" class="text-link">stronie plików admina</a> i mają specjalne właściwości opisane w sekcji <a href="#files" class="text-link">pliki humbak</a>. Żeby ich funkcjonalność działała, w html zawartości muszą one być używane za pomocą specjalnego tagu <code style="background-color: hsl(0 0% 25%); color: white; border-radius: 0.25rem; padding-block: 0.125rem; padding-inline: 0.25rem;"><span style="color: hsl(0 0% 60%)">&lt;</span><span style="color: hsl(205 100% 65%)">HumbakFile</span> <span style="color: hsl(205 100% 80%)">fid</span><span style="color: hsl(0 0% 60%)">=</span><span style="color: hsl(30 100% 65%)">"1"</span><span style="color: hsl(0 0% 60%)">&gt;</span></code>. Te tagi wymagają atrybutu <b>fid</b> który zawiera id docelowego <em>pliku humbak</em> i akceptują wszystkie poprawne html atrybuty, takie jak <em>class</em> lub <em>style</em>.</p>
	<HumbakFile fid="${pagesHumbakFileTag}" loading="lazy"></HumbakFile>
</section>

<section>
	<h3>menu</h3>
	<p>Po utworzeniu stron możesz zarządzać ułożeniem menu na <a href="/admin/menu" target="_blank" class="text-link">stronie menu admina</a>.</p>
...
<section>
	...
	<p><b>Pliki humbak</b> mogą być wgrywane i zarządzane na <a href="/admin/files" target="_blank" class="text-link">stronie plików admina</a>.</p>
	<p class="indent">
		W lewym górnym rogu znajdują się <b>okruchy folderów</b>, które pokazują twój obecny folder, jego ścieżkę i mogą być użyte do nawigowania między folderami. Na prawo od nich są 2 przyciski do zmieniania widoku pomiędzy widokiem <b>listy</b> a <b>kafelkami</b>. Obok nich jest przycisk <b>zapisz</b>.
	</p>
	<HumbakFile fid="${filesToggling}" loading="lazy"></HumbakFile>
	<p>Poniżej powyższych wylistowane są wszystkie twoje pliki, z wyjątkiem pierwszego elementu, który służy do tworzenia nowych folderów i wgrywania nowych plików. Poza edytowaniem atrybutów plików i folderów możesz nawigować do poszczególnych folderów oraz usuwać/edytować pliki i foldery. Przycisk <b>przesuń</b> może być albo przeciągnięty i upuszczony do konkretnego folderu, albo kliknięty na żeby otworzyć <b>dialog przesuwania</b>.</p>
	<HumbakFile fid="${filesMoving}" loading="lazy"></HumbakFile>
...
<section>
	<h3>global</h3>
	<p>Kiedy na <a href="/admin" target="_blank" class="text-link">stronie głównej admina</a> możesz edytować <em>css</em> i <em>metę</em> poszczególnych stron, <a href="/admin/global" target="_blank" class="text-link">strona global admina</a> jest używana do edytowania <em>css</em> i <em>mety</em> dzielonej między wszystkimi stronami (z wyjątkiem <em>mety</em>, która jest dzielona między wszystkimi stronami o tym samym języku).</p>
	<p class="indent">
...
<section>
	<h3>slider</h3>
	<p><b>Slider</b> znajdujący się na górze wszystkich stron może być konfigurowany na <a href="/admin/slider" target="_blank" class="text-link">stronie slider admina</a>.</p>
	<p class="indent">
		Pierwszy rząd na stronie zawiera <b>wybór języka</b>, <b>wybór slajdu</b>, kolejno <em>przyciski kontrolne</em> <b>pliki humbak</b>, <b>ustawienia slidera</b> <b>formatowanie zawartości</b> oraz przyciski <b>wyczyść</b> i <b>zapisz</b>. Poniżej tych wszystkich elementów znajduje się <b>edytor</b>, pod którym jest formularz do zarządzania atrybutami obecnego slajdu: <em>nazwa</em>, <em>język</em> i <em>widoczność</em>.
	</p>
	<HumbakFile fid="${sliderForm}" loading="lazy"></HumbakFile>
	<p>Poniżej formularza są <b>podgląd</b>, pokazujący wygląd obecnie edytowanego slajdu i <b>slider</b>, będący kopią slidera widocznego na <a href="/" target="_blank" class="text-link">stronie głównej</a>. O ile <em>podgląd</em> aktualizuje się na bieżąco z <em>html'em</em> obecnego slajdu, to <em>slider</em> aktualizuje się dopiero po zapisaniu zmian.</p>
	<HumbakFile fid="${sliderPreviews}" loading="lazy"></HumbakFile>
...
<section>
	<h3>stopka</h3>
	<p>Podobnie do <b>slidera</b>, <b>stopka</b> może być edytowana na <a href="/admin/footer" target="_blank" class="text-link">stronie stopka admina</a>.</p>
	<p class="indent">
		Na górze strony znajduje się <b>wybór języka</b> i przycisk <b>zapisz</b>, poniżej których jest interaktywny podgląd stopki. W pierwszej kolumnie można dodawać i edytować emaile, w drugiej numery telefonu a w ostatniej link lokacji. Poniżej tych kolumn, w drugim rzędzie znajdują się <em>linki do sociali</em>, które mogą być edytowane w <b>dialog sociali</b>.
	</p>
	<HumbakFile fid="${footerOverview}" loading="lazy"></HumbakFile>

	<h4>dialog sociali</h4>
	<p>W środku dialogu możesz dodawać i edytować kilka wybranych <em>social linków</em>, które pokażą się na dole stopki.</p>
	<HumbakFile fid="${footerSocialsDialog}" loading="lazy"></HumbakFile>
</section>

<section>
	<h3>ustawienia</h3>
	<p>Na samym końcu, na <a href="/admin/settings" target="_blank" class="text-link">stronie ustawień admina</a> możesz się wylogować lub zmienić swoją <em>nazwę użytkownika</em> i <em>hasło</em>.</p>
	<HumbakFile fid="${settings}" loading="lazy"></HumbakFile>
</section>
`;
}
...
export function enCaspianLakesPageContent([imgId1, imgId2]: [number, number]) {
	...
	<a href="https://www.nationsonline.org/oneworld/map/Caspian-Sea-map.htm" target="_blank" class="block my-4">
		<HumbakFile fid="${imgId1}"></HumbakFile>
	</a>
