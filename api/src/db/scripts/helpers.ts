...
<section>
	<h3>settings</h3>
	<p>Lastly, on the <a href="${env.ADMIN_URL}/settings" target="_blank" class="text-link">admin settings page</a> you can log out and change your admin account's <em>name</em> and <em>password</em>.</p>
...
<section>
	<h3>ustawienia</h3>
	<p>Na samym końcu, na <a href="${env.ADMIN_URL}/settings" target="_blank" class="text-link">stronie ustawień admina</a> możesz się wylogować lub zmienić swoją <em>nazwę użytkownika</em> i <em>hasło</em>.</p>
	<HumbakFile fid="${settings}" loading="lazy"></HumbakFile>
</section>
`;
}
