...
<template>
	<main class="grid grid-cols-[1fr_min-content] grid-rows-[min-content_1fr] mx-auto max-w-256 min-h-inherit w-full gap-x-3 gap-y-5 px-4 pb-4 pt-[1.125rem] lg:px-0">
