...
<template>
	<div
		class="fixed right-2 top-2 z-100 max-h-screen max-w-[calc(100%_-_4rem)] w-64 flex flex-col gap-3 overflow-y-hidden pb-2"
		aria-hidden
	>
		<TransitionGroup>
			<div
				...
				:key="id"
				class="toast-progress relative min-h-12 w-full flex shrink-0 items-center gap-3 overflow-hidden rounded-md bg-neutral-200 p-2 pb-3 shadow-md after:absolute after:bottom-0 after:left-0 after:h-1 after:w-0 dark:bg-neutral-800 after:content-empty"
