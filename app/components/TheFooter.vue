...
const props = defineProps<{
	data?: IPublicLanguageData['footerContents'];
}>();
...
<template>
	<footer class="relative grid grid-cols-1 mt-auto w-full justify-items-center gap-6 border-t border-black bg-humbak pb-4 pt-8 text-black lg:px-8 md:px-[clamp(2rem,_-12.25rem_+_29.6875vw,_6.75rem)] md:pb-6">
